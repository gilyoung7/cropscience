...
OUT_ROOT = Path(os.environ.get("CURRICULUM_OUT_ROOT",
                               CS / "rice/outputs_allpests_e5d_curriculum"))
...
def dev_ckpt(pest, year):                    return pest_root(pest) / f"dev/{year}/final"
...
def clean_ckpt(pest, year):                  return pest_root(pest) / f"clean/{year}/final"
