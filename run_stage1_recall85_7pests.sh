...
for pest in "${ORDER[@]}"; do
  ...
  eval_csv="${out_root}/eval/event_eval_${pest}_run4_stage1_xgb_nowcast_w28_s1_tpos_split${seed}_siteyear_ymin2002_tauAlertR85_minFAR_k3_ma1_nogate_abs.csv"
  log_file="${out_root}/logs/train_eval_recall85_gpu.log"
  ...
  # ---- EVAL (recall>=0.85, minimize false_alert_rate) ----
