...
for pest in "${ORDER[@]}"; do
  ...
  ckpt="${out_root}/ckpt/event_run4_xgb_nowcast_w56_s1_tpos_split${seed}_siteyear_ymin2002.pt"
  oof_csv="${out_root}/ckpt/oof_train_seed${seed}_5fold_w56.csv"
  probs_csv="${out_root}/eval/event_eval_${pest}_run4_stage1_xgb_nowcast_w56_s1_tpos_split${seed}_siteyear_ymin2002_tauAlertR85_minFAR_k3_ma1_nogate_abs_probs.csv"
  cascade_dir="${out_root}/cascade_v2_M14_w56_full"
  log_file="${out_root}/logs/cascade_v2_M14_w56.log"

  echo "=========================================="
  echo "[$pest] seed=$seed w=56 cascade v2 M=14 start: $(date -Iseconds)"
  echo "=========================================="
