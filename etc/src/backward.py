...
from etc.src.sfs import make_loaders_for_features
from etc.src.dataset import build_samples_season, split_by_sample, log_split_fingerprint
...
def backward_elimination(
    ...
    train_s, val_s, test_s = split_by_sample(samples_full, val_frac=0.1, test_frac=0.1, seed=split_seed)
