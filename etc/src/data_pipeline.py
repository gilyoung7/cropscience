...
from etc.configs.base import DAILY_CACHE_DIR as BASE_DAILY_CACHE_DIR
...
def load_daily(path: Path) -> pd.DataFrame:
    ...
    if "GDD10_cum" not in daily.columns:
        raise ValueError("Daily data must include GDD10_cum")
